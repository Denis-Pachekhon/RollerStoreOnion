...
namespace RollerStore.Api.IntegrationTests
{
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                var serviceDescriptor = services
                                            .SingleOrDefault(d => d.ServiceType == typeof(DbContextOptions<RollerStoreDbContext>));
                ...
                services.AddDbContext<RollerStoreDbContext>(options =>
                {
                ...
                using (var serviceScope = servicesProvider.CreateScope())
                {
                    ...
                    var db = scopedServices.GetRequiredService<RollerStoreDbContext>();
